class UserStocksController < ApplicationController
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path, 
          notice: "Stock #{@user_stock.stock.ticker} succussfully added." }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'User stock successfully removed from portfolio.' }
